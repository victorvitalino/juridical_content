...
ActiveRecord::Schema.define(version: 20151118115055) do
  ...
  add_index "author_users", ["email"], name: "index_author_users_on_email", unique: true
  add_index "author_users", ["reset_password_token"], name: "index_author_users_on_reset_password_token", unique: true
